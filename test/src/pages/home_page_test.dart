...
void main() {
  ...
  setUp(() {
    ...
    when(service.getUpcomingMovies(any)).thenAnswer(
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text(list.first.title), findsOneWidget);
      expect(find.text(list.first.genres), findsOneWidget);
      expect(find.text('Release: ${list.first.formatedReleasedData}'), findsOneWidget);
